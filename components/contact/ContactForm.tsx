  ...
  return (
    <section id='the-team-section-about' className='w-full py-14 lg:py-20 px-4 bg-white lg:px-[100px] flex flex-col-reverse lg:flex-row items-start justify-center'>
        <div className="w-full lg:w-[50%] mt-10 lg:mt-0">
            <form id="contact-us" onSubmit={(e) => {e.preventDefault(); alert("Email submitted successfully! ✅")}} className="w-full">
            ...
            <textarea required placeholder='Talk to us...' className="w-full lg:w-[480px] h-[150px] rounded-[6px] bg-[#F1F1F1] px-6 text-sm lg:text-[24px] text-primary-black/70 outline-0 border-1 border-[#CDCDCD] stroke-0 mb-3" />
