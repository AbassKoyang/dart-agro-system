...
const Footer = () => {
  return (
    <footer className='w-full pt-24 bg-white'>
        ...
        <div className="px-4 lg:px-[20px] bg-primary-green w-full h-[100px] lg:h-[137px] flex items-center justify-center gap-5 lg:justify-between overflow-hidden">
            <svg className="size-[60px] lg:size-[150px] translate-y-[50px] lg:translate-y-[45%]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className="text-4xl lg:text-[140px] text-black font-dm-mono font-medium lg:leading-[70px] translate-y-[45px] lg:translate-y-[87%]">DartAgro System</h1>
        </div>
    </footer>
  )
}
