  ...
  return (
    <footer className='w-full pt-24 bg-white'>
        ...
        <div   className="quote-section px-4 lg:px-[20px] bg-primary-green w-full h-[70px] lg:h-[137px] flex items-center justify-center gap-5 lg:justify-between overflow-hidden">
            <svg className="footer size-[55px] lg:size-[150px] translate-y-[35px] lg:translate-y-[45%]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className="footer text-2xl lg:text-[130px] text-black font-dm-mono font-medium lg:leading-[70px] translate-y-[32px] lg:translate-y-[87%]">DartAgro System</h1>
        </div>
    </footer>
  )
}
