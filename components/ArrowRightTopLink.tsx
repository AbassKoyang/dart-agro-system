...
const ArrowRightTopLink = ({linkStyle, svgStyle}:{linkStyle: string; svgStyle: string}) => {
  return (
    <Link href={''} className={`${linkStyle} bg-[#121212] flex items-center justify-center rounded-full`}>
